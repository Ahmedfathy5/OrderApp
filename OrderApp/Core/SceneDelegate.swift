...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    var orderTapbBarItem: UITabBarItem!
    
   @objc func updateOrderBadge() {
       switch NetworkManager.shared.order.menuItems.count {
       case 0:
           orderTapbBarItem.badgeValue = nil
       case let count:
           orderTapbBarItem.badgeValue = String(count)
       }
    }
